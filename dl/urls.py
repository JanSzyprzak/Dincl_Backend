...
from .api_views import SurveyViewset, register_visit, top_five_weekly_voivodeships, top_five_monthly_voivodeships, number_of_all_surveys, number_of_top5monthly_surveys, number_of_top5weekly_surveys
from . import views
